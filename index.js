	...
	client.on('chat-update', async (mek) => {
			...
			switch(command) {
				...
				case 'sticker':
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`💟 Envie fotos,gifs ou videos com até 5 segundos, com a legenda ${prefix}sticker para criar uma figurinha!💟`)
					}
					break
					case 'gtts':
				...
				case '+18':
					...
					buffer = await getBuffer(`https://i.imgur.com/Mboi37b.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*o adm proibiu porno no grupo* 🙄'})
					break
				case 'criador':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/aBN74lQ.jpg`)
				...
				case 'loli1':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Aqui está sua Loli👉👈'})
					break
				case 'hentai':
					memein = await kagApi.memeindo()
				...
				case 'yt':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/rQwzPqb.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '🎬 𝘾𝙖𝙣𝙖𝙡 𝙙𝙤 𝙃𝙚𝙧𝙗𝙚𝙧𝙩𝙝🎬:️\nPor favor, Inscreva-se e ajude o canal a crescer mais!\n\n https://youtube.com/c/herberthduarte'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
        ...
        case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝙉𝙊𝙑𝙊(𝘼) 𝘼𝘿𝙈!👮 \n\n @${mentioned[0].split('@')[0]} Deixou de ser membro(a) comum e passou a ser Administrador(a) do Grupo✔️`, mentioned, true)
				...
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝙈𝙀𝙈𝘽𝙍𝙊(𝘼) 𝘾𝙊𝙈𝙐𝙈!🤧 \n\n @${mentioned[0].split('@')[0]} Foi rebaixado(a) de ADM para membro(a) comum!✔️`, mentioned, true)
				...
				case 'kick':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = '𝙎𝙀 𝙁𝙊𝘿𝙀𝙐! Removido(a) com sucesso✔️ :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
						...
						mentions(`𝙎𝙀 𝙁𝙊𝘿𝙀𝙐! Removido(a) com sucesso! : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'ademirs':
